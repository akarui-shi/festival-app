...
export function PublicLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className={`sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur-md transition-shadow duration-300 ${scrolled ? 'shadow-card' : 'shadow-none'}`}>
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-3">
            <Link to="/" className="flex items-center gap-2 group">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-[hsl(var(--terracotta-dark))] shadow-sm transition-transform duration-200 group-hover:scale-105">
                <span className="font-heading text-lg font-bold text-primary-foreground">К</span>
              </div>
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.path}
                  to={link.path}
                  className={`relative rounded-lg px-3.5 py-2 text-sm font-medium transition-colors duration-150 after:absolute after:bottom-0.5 after:left-3.5 after:right-3.5 after:h-0.5 after:rounded-full after:transition-all after:duration-150 ${
                    active
            ...
            {isAuthenticated ? (
              <>
                ...
                <Link to="/profile" className="flex h-9 items-center gap-2 rounded-full bg-primary/10 px-3 transition-all duration-150 hover:bg-primary/15">
                  ...
                  <span className="max-w-24 truncate text-sm font-semibold text-primary">
      ...
      <footer className="border-t border-border bg-card/60">
        <div className="container mx-auto px-4 py-12">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            <div className="sm:col-span-2 lg:col-span-1">
              <div className="flex items-center gap-2">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-[hsl(var(--terracotta-dark))] shadow-sm">
                  <span className="font-heading text-base font-bold text-primary-foreground">К</span>
                </div>
                <span className="font-heading text-xl text-foreground">Культура</span>
              </div>
              <p className="mt-3 max-w-xs text-sm leading-relaxed text-muted-foreground">
                Платформа культурных событий для малых городов России. Находите, записывайтесь, делитесь.
              </p>
            </div>
            ...
            <div>
              <p className="mb-4 text-xs font-semibold uppercase tracking-widest text-muted-foreground">Организаторам</p>
              <div className="flex flex-col gap-2.5">
            ...
            <div>
              <p className="mb-4 text-xs font-semibold uppercase tracking-widest text-muted-foreground">Контакты</p>
              <a href="mailto:info@kultura.ru" className="text-sm text-muted-foreground transition-colors hover:text-primary">
                info@kultura.ru
              </a>
            </div>
          </div>
          ...
          <div className="mt-10 flex flex-col items-center justify-between gap-3 border-t border-border pt-6 sm:flex-row">
            <p className="text-xs text-muted-foreground">© 2026 Культура. Все права защищены.</p>
            <p className="text-xs text-muted-foreground/60">Дипломный проект</p>
          </div>
        </div>
      </footer>
    </div>
