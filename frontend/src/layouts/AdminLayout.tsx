          ...
          <div className="flex h-full flex-col">
            <div className="border-b border-border px-5 py-5">
              <Link to="/admin" className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-heading text-lg text-foreground">Админ-панель</p>
                  <p className="text-xs text-muted-foreground">Модерация и управление</p>
                </div>
              </Link>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Раздел администрирования</p>
                </div>
              </div>
