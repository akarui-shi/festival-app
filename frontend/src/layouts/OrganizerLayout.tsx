        ...
        >
          <div className="flex h-full flex-col">
            ...
            <div className="border-b border-border px-5 py-5">
              <Link to="/organizer" className="group flex items-center gap-3">
                ...
                <div>
                  <p className="font-heading text-base font-bold text-foreground leading-tight">Организатор</p>
                  <p className="text-[11px] text-muted-foreground">Управление событиями</p>
                </div>
              </Link>
            </div>
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="hidden text-xs text-muted-foreground sm:block">Рабочая зона организатора</p>
                </div>
              </div>
