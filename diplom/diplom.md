...
[В Первой главе рассматриваются предметная область, особенности культурной жизни малых городов, анализируются существующие способы информирования о мероприятиях и программные аналоги, а также формируются требования к веб‑приложению.]{.mark}
